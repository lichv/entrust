...
use Lichv\Entrust\EntrustPermission;
...
use Lichv\Entrust\Traits\EntrustUserTrait;
...
If you don't, then try `php artisan vendor:publish` and, if it does not appear, manually copy the `/vendor/lichv/entrust/src/config/config.php` file in your config directory and rename it `entrust.php`.
